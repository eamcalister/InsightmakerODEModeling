...
},
{
  ...
  "number": "2.1.12",
  "title": "",
  "body": " Create a new stock whose flow rate is (dividing by will make this into a sum rather than an integral, which is what the optimizer does, really). Use this to compare the for and to verify that the latter gives a better global fit to the data.  "
},
{
...
},
{
  ...
  "number": "2.2.4",
  "title": "",
  "body": " Now (2024 as of writing) MLB publishes drag coefficients (values of in ). Do a little research to compare values you would compute from your estimates of . How far off are we and what might be the cause of the error?  "
},
{
...
},
{
  ...
  "number": "2.3.1",
  "title": "",
  "body": " Explain why the expressions and are both always positive. Develop and Insight with one inflow, one outflow, and two variables (with sliders). ( For students turning this in, you will need to submit your Insightmaker files. )  "
},
{
